          ...
          <div class="row">
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#profile" data-toggle="tab">
                            <i class="material-icons">card_giftcard</i>Sản phẩm
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#messages" data-toggle="tab">
                            <i class="material-icons">calendar_view_day</i> Ngày
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-lg-6 col-md-12" >
              <div class="card">
                ...
                <div class="card-body table-responsive" id="emp_list">
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"include/pagination_index.php",
			method:"POST",
			data:{page:page},
	...
	{
	$.ajax({
			url:"include/pagination_list.php",
			method:"POST",
			data:{page:page},
			success:function(data){
				$("#emp_list").html(data);
	...
	$(document).on('click', '.pagination_link_list', function()
	{
		var page = $(this).attr("id");
